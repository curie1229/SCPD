...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden = nn.Linear(self.n_features*self.embed_size, self.hidden_size, bias=True, device=None, dtype=None)
        nn.init.xavier_uniform_(self.embed_to_hidden.weight, gain=1)
        self.dropout = nn.Dropout(p=self.dropout_prob)
        self.hidden_to_logits = nn.Linear(self.hidden_size, self.n_classes, bias=True, device=None, dtype=None)
